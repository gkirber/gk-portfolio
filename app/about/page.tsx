			...
			<div className='container mx-auto px-0'>
				<div className='flex flex-col xl:flex-row items-center gap-24 w-full h-[680px]'>
					...
					<div className='hidden xl:flex flex-col w-full h-full pt-14 max-w-[430px] relative'>
						...
						/>
						{/* overlay */}
						<div className='w-full h-[60px] absolute left-0 top-[420px] right-0 bg-gradient-to-t from-primary via-primary/40 z-30'></div>
						{/* blob */}
						...
						<Socials
							containerStyles='flex gap-4 z-40 w-max transform translate-x-[75px]'
					...
					<ScrollArea className='w-full h-[680px]'>
						<div>
							...
							<h2 className='h2 mb-6'>
								<span className='text-accent'>Iurii</span> Rebryk
							</h2>
